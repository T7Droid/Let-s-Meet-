...
public class OutgoingInvitationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textFirstChar = findViewById(R.id.textFirstCharOutGoing);
        textUserName = findViewById(R.id.textUserNameOutGoing);
        textEmail = findViewById(R.id.textEmailOutGoing);
        ...
        try {
            ...
            if (receivers != null && receivers.size() > 0){
                ...
                for (int i = 0; i < receivers.size(); i++){
                    ...
                    usersNames.append(receivers.get(i).firstName).append(" ").append(receivers.get(i).lastname).append("\n");
                }
    ...
    private void cancelInvitation(String receiverToken, ArrayList<User> receivers) {
        try {
            ...
            data.put(Constants.REMOTE_INVITATION_RESPONSE, Constants.REMOTE_MSG_INVITATION_CANCELLED);
